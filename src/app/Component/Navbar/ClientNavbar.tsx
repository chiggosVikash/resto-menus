  ...
  return (
    <div className="relative">
      ...
      <div className={`${isScrolled ? 'fixed top-0 left-0 right-0 z-[100]' : ''} transition-all duration-300`}>
        <nav className={`${isScrolled ? 'bg-primary text-onSurface' : 'bg-surface text-onSurface'} transition duration-300 border-b border-gray-200 w-full py-4 ${isScrolled ? 'shadow-md' : ''}`}>
          <Container>
